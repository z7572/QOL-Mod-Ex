...
class GameManagerPatches
{
    ...
    [HarmonyPostfix]
    private static void RestartGamePostfix(GameManager __instance)
    {
    ...
    public static void NetworkAllPlayersDiedButOnePostfix(ref byte winner, GameManager __instance)
    {
        ...
        var isUserWinner = winner == Helper.networkPlayer.NetworkSpawnID;
    ...
    private static void UpdateGlobalStats(bool isUserWinner)
    {
        try
        {
            ...
            var playerCurrentStats = Helper.networkPlayer.GetComponent<CharacterStats>();
            ...
            var damageTaken = (int)Traverse.Create(Helper.networkPlayer.GetComponent<Controller>())
