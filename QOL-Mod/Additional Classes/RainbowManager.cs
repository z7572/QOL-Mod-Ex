...
public class RainbowManager : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        var character = Helper.networkPlayer.transform.root.gameObject;
    ...
    private void Update()
    {
        ...
        var rbColor = new HSBColor(Mathf.PingPong(Time.time * Speed, 1), 1, 1).ToColor();
    ...
    public void OnDisable()
    {
        ...
        var player = Helper.networkPlayer.transform.root.gameObject;
        ...
        ResetPlayerColor(ConfigHandler.DefaultColors[Helper.networkPlayer.NetworkSpawnID], player);
    }
